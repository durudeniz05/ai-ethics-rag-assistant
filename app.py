...
def ask_rag_assistant(question, gemini_client, collection, embedding_function):
    ...
    try:
        ...
        # Not: Modeli 'gemini-1.5-flash' olarak güncelledim, daha hızlıdır. 
        # 'gemini-2.5-flash' diye bir model henüz yok, 'gemini-1.5-pro' veya 'gemini-1.5-flash' kullanabilirsiniz.
    ...
    with st.sidebar:
        ...
        if st.button("Dokümanları İşle ve Kaydet"):
            if uploaded_files:
                ...
                # 'collection.delete()' bloğu buradan kaldırıldı (Hata düzeltmesi)
