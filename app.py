...
# =================================================================================
# 5. ADIM: STREAMLIT WEB UYGULAMASI (Minimal Debug - ChromaDB Test)
# =================================================================================
...
# Other imports
try: from chromadb import Client, Settings; from chromadb.api.models.Collection import Collection; print("--- chromadb imported successfully ---") # Import Collection type
...
# --- 2. Setup Components (ChromaDB Test) ---
# Cache disabled
